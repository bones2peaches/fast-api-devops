...
from app.services.auth import get_event_current_user, get_current_user
...
async def nchan_user_join(
    ...
    return await ChatroomUsers.query(chatroom_id=chatroom.id, session=db)
